  ...
  try {
    ...
    const cardHTML = `
      <div  id="card" class="card grid border border-gray-300 rounded-lg text-white m-2 p-2 bg-blue-500">
        ...
        <a href="https://github.com/${data.login}" target="_self"><i class="fa-xl fa-brands fa-github"></i></a>
         <button id="remove" class="remove-btn col-2"><i class="fas fa-trash fa-fw fa-xl   " style="color: #ffffff;"
         onmouseover="style='color:red'" onmouseleave="style='color:white'"></i></button>
        </div>
      </div>
    `;
